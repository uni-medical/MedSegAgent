...
The local implementation passed **130 automated tests**, including real stdio MCP
discovery of four tools, empty-target ToolError checks, specialized-task default speed,
